...
To modify the pipelines for `distributed-workloads` in the `rhoai-3.5-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for distributed-workloads (rhoai-3.5-ea.1)"
